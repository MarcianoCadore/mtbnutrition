...
class Settings(BaseSettings):
    ...
    GEMINI_API_KEY: str = ""
    # Quem atende as chamadas de IA: "gemini" (grátis, padrão desde 09/2026),
    # "claude" (API paga da Anthropic) ou "" para decidir pela chave que existir.
    IA_PROVEDOR: str = "gemini"
